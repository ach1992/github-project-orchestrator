...
| `G04` Dependency, Flow & Project Health Management | `WIP-FLOW`, `SYNTHESIZE-WORK`, `MASTER-STOP-CANONICAL`, `DRIFT-RECONCILE`, `CONCURRENCY-OPTIMISTIC` | J, O, R, AP, AQ, CN, BH, DL, DR | plan validity, critical-path change, and project-health response |
