...
| `G14` Repository Readiness, Hygiene & Self-Repair | `BOOTSTRAP-PROPORTIONAL`, `ARTIFACT-FITNESS`, `MUTATION-IDEMPOTENT`, `PROTECT-UNRELATED`, `DRIFT-RECONCILE`, `READY-DONE-SEMANTICS` | A, B, AU, AZ, BS, BT, BU, BE, DL | stale project-system repair without parallel duplicate mechanisms |
