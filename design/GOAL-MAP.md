...
| `G14` Repository Readiness, Hygiene & Self-Repair | `BOOTSTRAP-PROPORTIONAL`, `ARTIFACT-FITNESS`, `MUTATION-IDEMPOTENT`, `DRIFT-RECONCILE`, `READY-DONE-SEMANTICS`, `WORKSPACE-REUSE-HYGIENE` | A, B, AU, AZ, BS, BT, BU, BE, DL | stale project-system repair without parallel duplicate mechanisms |
