...
| `G07` Engineering Quality & Evidence | `EVIDENCE-BEATS-NARRATIVE`, `NO-FABRICATION`, `ENGINEERING-CONCERNS-PROPORTIONAL`, `REVIEW-EFFECTIVE-CHANGE`, `REVIEW-IDENTITY-FRESH`, `UNTRUSTED-EXECUTION-SURFACE`, `CI-CLASSIFY`, `SELF-AUTHORED-FRESH-REVIEW`, `POST-RELEASE-EVIDENCE` | E, F, G, M, AB, AC, CL, BC, CO, DH | correctness/security/privacy/resilience/diagnosability/performance/operations evidence proportional to the change |
...
| `G11` Verified Review, Integration, Release & Operations | `ENGINEERING-CONCERNS-PROPORTIONAL`, `REVIEW-EFFECTIVE-CHANGE`, `REVIEW-IDENTITY-FRESH`, `UNTRUSTED-EXECUTION-SURFACE`, `CI-CLASSIFY`, `CONFLICT-RECONCILE`, `INTEGRATION-GATE`, `SELF-AUTHORED-FRESH-REVIEW`, `POST-INTEGRATION-RECONCILE`, `RELEASE-MODEL-DISCOVER`, `INTEGRATED-NOT-DELIVERED`, `PRODUCTION-DETERMINISTIC-EFFECT`, `MIGRATION-ROLLBACK`, `PRODUCTION-GATE`, `POST-RELEASE-EVIDENCE`, `INCIDENT-CONTAINMENT`, `RELEASE-CLOSEOUT` | E, G, H, M, AC, CJ, CO, CT, CS, BO, CV, DH | complete release path tied to immutable artifact, operational supportability, and delivery evidence |
