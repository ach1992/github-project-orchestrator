...
| machine relay is prepared/presented | MachineRelay classification in `SKILL.md` + portable transport in `relay-transport.md` + role-specific payload owner; transport creates no lifecycle/state |
