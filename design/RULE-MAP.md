...
| `MACHINE-RELAY-PORTABLE` | AI-to-AI relay payloads are English by default and become one complete copy target when human-relayed, while domain owners retain payload semantics and no workflow state/control is weakened. | `SKILL.md` human-relay kernel | post-v1.2.0 requirement: `docs/PROJECT-SPEC.md` §3.2 | AT, BC, CK, DI |
