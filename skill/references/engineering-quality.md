...
- long-suite bottlenecks: prefer isolation-preserving parallelization/sharding over coverage reduction; prove complete, non-overlapping isolated aggregate coverage and measured critical-path gain, stopping at diminishing returns;
