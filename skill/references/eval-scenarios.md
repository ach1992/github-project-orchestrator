...
- Cross-repository coordination, dependencies, shared outcomes, discovery, and technical access never widen `RepositoryMutationScope`; an out-of-scope related repository remains read-only/handoff for that Master, and materially ambiguous writable scope is clarified before mutation.
