...
| material planning/dependency coordination; delegation/parallelism; Worker absorption; no-READY synthesis; anti-spin handling; terminal decision | [references/master-cycle.md](references/master-cycle.md) | continue until `MASTER_STOP(...)` is true |
